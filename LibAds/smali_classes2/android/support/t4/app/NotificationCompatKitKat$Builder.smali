.class public Landroid/support/t4/app/NotificationCompatKitKat$Builder;
.super Ljava/lang/Object;
.source "NotificationCompatKitKat.java"

# interfaces
.implements Landroid/support/t4/app/NotificationBuilderWithBuilderAccessor;
.implements Landroid/support/t4/app/NotificationBuilderWithActions;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/support/t4/app/NotificationCompatKitKat;
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mActionExtrasList:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->b:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;

    .line 74
    if-eqz p20, :cond_0

    .line 75
    iget-object v4, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
    ...
    .line 78
    iget-object v5, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mContentView:Landroid/widget/RemoteViews;

    .line 96
    move-object/from16 v0, p25

    iput-object v0, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mBigContentView:Landroid/widget/RemoteViews;
...
# virtual methods
.method public addAction(Landroid/support/t4/app/NotificationCompatBase$Action;)V
    .locals 2
    .param p1, "action"    # Landroid/support/t4/app/NotificationCompatBase$Action;

    .prologue
    .line 101
    iget-object v0, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mActionExtrasList:Ljava/util/List;

    iget-object v1, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->b:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/t4/app/NotificationCompatJellybean;->writeActionAndGetExtras(Landroid/app/Notification$Builder;Landroid/support/t4/app/NotificationCompatBase$Action;)Landroid/os/Bundle;
...
.method public build()Landroid/app/Notification;
    ...
    .prologue
    .line 111
    iget-object v2, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mActionExtrasList:Ljava/util/List;

    invoke-static {v2}, Landroid/support/t4/app/NotificationCompatJellybean;->buildActionExtrasMap(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 115
    iget-object v2, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
    ...
    .line 118
    :cond_0
    iget-object v2, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->b:Landroid/app/Notification$Builder;

    iget-object v3, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
    ...
    iget-object v2, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mContentView:Landroid/widget/RemoteViews;
    ...
    .line 123
    :cond_1
    iget-object v2, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->mBigContentView:Landroid/widget/RemoteViews;
...
.method public getBuilder()Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 106
    iget-object v0, p0, Landroid/support/t4/app/NotificationCompatKitKat$Builder;->b:Landroid/app/Notification$Builder;
