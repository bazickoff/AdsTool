.class Landroid/support/t4/app/NotificationCompat$NotificationCompatImplApi21;
.super Landroid/support/t4/app/NotificationCompat$NotificationCompatImplApi20;
...
.method constructor <init>()V
    ...
    .prologue
    .line 814
    invoke-direct {p0}, Landroid/support/t4/app/NotificationCompat$NotificationCompatImplApi20;-><init>()V
...
.method public build(Landroid/support/t4/app/NotificationCompat$Builder;Landroid/support/t4/app/NotificationCompat$BuilderExtender;)Landroid/app/Notification;
    ...
    .prologue
    .line 817
    new-instance v2, Landroid/support/t4/app/NotificationCompatApi21$Builder;
    ...
    iget-object v0, v0, Landroid/support/t4/app/NotificationCompat$Builder;->mCategory:Ljava/lang/String;
    ...
    iget v0, v0, Landroid/support/t4/app/NotificationCompat$Builder;->mColor:I

    move/from16 v24, v0

    move-object/from16 v0, p1

    iget v0, v0, Landroid/support/t4/app/NotificationCompat$Builder;->mVisibility:I

    move/from16 v25, v0

    move-object/from16 v0, p1

    iget-object v0, v0, Landroid/support/t4/app/NotificationCompat$Builder;->mPublicVersion:Landroid/app/Notification;
    ...
    invoke-virtual {v0, v1}, Landroid/support/t4/app/NotificationCompat$NotificationCompatImplApi21;->getExtras(Landroid/app/Notification;)Landroid/os/Bundle;
...
.method public getBundleForUnreadConversation(Landroid/support/t4/app/NotificationCompatBase$UnreadConversation;)Landroid/os/Bundle;
    .locals 1
    .param p1, "uc"    # Landroid/support/t4/app/NotificationCompatBase$UnreadConversation;

    .prologue
    .line 841
    invoke-static {p1}, Landroid/support/t4/app/NotificationCompatApi21;->getBundleForUnreadConversation(Landroid/support/t4/app/NotificationCompatBase$UnreadConversation;)Landroid/os/Bundle;
...
.method public getCategory(Landroid/app/Notification;)Ljava/lang/String;
    ...
    .prologue
    .line 836
    invoke-static {p1}, Landroid/support/t4/app/NotificationCompatApi21;->getCategory(Landroid/app/Notification;)Ljava/lang/String;
...
.method public getUnreadConversationFromBundle(Landroid/os/Bundle;Landroid/support/t4/app/NotificationCompatBase$UnreadConversation$Factory;Landroid/support/t4/app/RemoteInputCompatBase$RemoteInput$Factory;)Landroid/support/t4/app/NotificationCompatBase$UnreadConversation;
    .locals 1
    .param p1, "b"    # Landroid/os/Bundle;
    .param p2, "factory"    # Landroid/support/t4/app/NotificationCompatBase$UnreadConversation$Factory;
    .param p3, "remoteInputFactory"    # Landroid/support/t4/app/RemoteInputCompatBase$RemoteInput$Factory;

    .prologue
    .line 848
    invoke-static {p1, p2, p3}, Landroid/support/t4/app/NotificationCompatApi21;->getUnreadConversationFromBundle(Landroid/os/Bundle;Landroid/support/t4/app/NotificationCompatBase$UnreadConversation$Factory;Landroid/support/t4/app/RemoteInputCompatBase$RemoteInput$Factory;)Landroid/support/t4/app/NotificationCompatBase$UnreadConversation;
