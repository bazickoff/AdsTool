.class public Landroid/support/t4/app/NotificationCompatJellybean$Builder;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/support/t4/app/NotificationCompatJellybean;
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mActionExtrasList:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->b:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;

    .line 108
    if-eqz p18, :cond_0

    .line 109
    iget-object v4, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mContentView:Landroid/widget/RemoteViews;

    .line 126
    move-object/from16 v0, p23

    iput-object v0, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mBigContentView:Landroid/widget/RemoteViews;
...
.method public addAction(Landroid/support/t4/app/NotificationCompatBase$Action;)V
    ...
    .prologue
    .line 131
    iget-object v0, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mActionExtrasList:Ljava/util/List;

    iget-object v1, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->b:Landroid/app/Notification$Builder;
...
.method public build()Landroid/app/Notification;
    ...
    .prologue
    .line 140
    iget-object v5, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->b:Landroid/app/Notification$Builder;
    ...
    invoke-static {v4}, Landroid/support/t4/app/NotificationCompatJellybean;->getExtras(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v5, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
    ...
    .line 151
    iget-object v5, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mActionExtrasList:Ljava/util/List;

    invoke-static {v5}, Landroid/support/t4/app/NotificationCompatJellybean;->buildActionExtrasMap(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 156
    :cond_2
    iget-object v5, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mContentView:Landroid/widget/RemoteViews;
    ...
    .line 159
    :cond_3
    iget-object v5, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->mBigContentView:Landroid/widget/RemoteViews;
...
.method public getBuilder()Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 136
    iget-object v0, p0, Landroid/support/t4/app/NotificationCompatJellybean$Builder;->b:Landroid/app/Notification$Builder;
