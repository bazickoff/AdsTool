.class Landroid/support/t4/media/session/MediaSessionCompatApi19;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/t4/media/session/MediaSessionCompatApi19$Callback;,
        Landroid/support/t4/media/session/MediaSessionCompatApi19$OnMetadataUpdateListener;
    }
.end annotation
...
.method public static createMetadataUpdateListener(Landroid/support/t4/media/session/MediaSessionCompatApi19$Callback;)Ljava/lang/Object;
    .locals 1
    .param p0, "callback"    # Landroid/support/t4/media/session/MediaSessionCompatApi19$Callback;

    .prologue
    .line 39
    new-instance v0, Landroid/support/t4/media/session/MediaSessionCompatApi19$OnMetadataUpdateListener;

    invoke-direct {v0, p0}, Landroid/support/t4/media/session/MediaSessionCompatApi19$OnMetadataUpdateListener;-><init>(Landroid/support/t4/media/session/MediaSessionCompatApi19$Callback;)V
...
.method static getRccTransportControlFlagsFromActions(J)I
    ...
    .line 59
    .line 60
    invoke-static {p0, p1}, Landroid/support/t4/media/session/MediaSessionCompatApi18;->getRccTransportControlFlagsFromActions(J)I
...
.method public static setMetadata(Ljava/lang/Object;Landroid/os/Bundle;J)V
    ...
    invoke-static {p1, v0}, Landroid/support/t4/media/session/MediaSessionCompatApi14;->buildOldMetadata(Landroid/os/Bundle;Landroid/media/RemoteControlClient$MetadataEditor;)V

    .line 46
    invoke-static {p1, v0}, Landroid/support/t4/media/session/MediaSessionCompatApi19;->addNewMetadata(Landroid/os/Bundle;Landroid/media/RemoteControlClient$MetadataEditor;)V
...
.method public static setTransportControlFlags(Ljava/lang/Object;J)V
    ...
    .line 35
    .end local p0    # "rccObj":Ljava/lang/Object;
    invoke-static {p1, p2}, Landroid/support/t4/media/session/MediaSessionCompatApi19;->getRccTransportControlFlagsFromActions(J)I
