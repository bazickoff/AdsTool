.class public Landroid/support/t4/media/session/MediaButtonReceiver;
...
.method public static buildMediaButtonPendingIntent(Landroid/content/Context;J)Landroid/app/PendingIntent;
    ...
    .prologue
    .line 170
    invoke-static {p0}, Landroid/support/t4/media/session/MediaButtonReceiver;->getMediaButtonReceiverComponent(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    :cond_0
    invoke-static {p0, v0, p1, p2}, Landroid/support/t4/media/session/MediaButtonReceiver;->buildMediaButtonPendingIntent(Landroid/content/Context;Landroid/content/ComponentName;J)Landroid/app/PendingIntent;
...
.method public static buildMediaButtonPendingIntent(Landroid/content/Context;Landroid/content/ComponentName;J)Landroid/app/PendingIntent;
    ...
    .line 207
    :cond_0
    invoke-static {p2, p3}, Landroid/support/t4/media/session/PlaybackStateCompat;->toKeyCode(J)I
...
.method public static handleIntent(Landroid/support/t4/media/session/MediaSessionCompat;Landroid/content/Intent;)Landroid/view/KeyEvent;
    .locals 4
    .param p0, "mediaSessionCompat"    # Landroid/support/t4/media/session/MediaSessionCompat;
    ...
    invoke-virtual {p0}, Landroid/support/t4/media/session/MediaSessionCompat;->getController()Landroid/support/t4/media/session/MediaControllerCompat;

    move-result-object v1

    .line 143
    .local v1, "mediaController":Landroid/support/t4/media/session/MediaControllerCompat;
    invoke-virtual {v1, v0}, Landroid/support/t4/media/session/MediaControllerCompat;->dispatchMediaButtonEvent(Landroid/view/KeyEvent;)Z
