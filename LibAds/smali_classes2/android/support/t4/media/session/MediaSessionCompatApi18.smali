.class Landroid/support/t4/media/session/MediaSessionCompatApi18;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/t4/media/session/MediaSessionCompatApi18$Callback;,
        Landroid/support/t4/media/session/MediaSessionCompatApi18$OnPlaybackPositionUpdateListener;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/support/t4/media/session/MediaSessionCompatApi18;->sIsMbrPendingIntentSupported:Z
...
.method public static createPlaybackPositionUpdateListener(Landroid/support/t4/media/session/MediaSessionCompatApi18$Callback;)Ljava/lang/Object;
    .locals 1
    .param p0, "callback"    # Landroid/support/t4/media/session/MediaSessionCompatApi18$Callback;

    .prologue
    .line 35
    new-instance v0, Landroid/support/t4/media/session/MediaSessionCompatApi18$OnPlaybackPositionUpdateListener;

    invoke-direct {v0, p0}, Landroid/support/t4/media/session/MediaSessionCompatApi18$OnPlaybackPositionUpdateListener;-><init>(Landroid/support/t4/media/session/MediaSessionCompatApi18$Callback;)V
...
.method static getRccTransportControlFlagsFromActions(J)I
    ...
    .line 99
    .line 100
    invoke-static {p0, p1}, Landroid/support/t4/media/session/MediaSessionCompatApi14;->getRccTransportControlFlagsFromActions(J)I
...
.method public static registerMediaButtonEventReceiver(Landroid/content/Context;Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    sget-boolean v2, Landroid/support/t4/media/session/MediaSessionCompatApi18;->sIsMbrPendingIntentSupported:Z
    ...
    sput-boolean v2, Landroid/support/t4/media/session/MediaSessionCompatApi18;->sIsMbrPendingIntentSupported:Z
...
.method public static setState(Ljava/lang/Object;IJFJ)V
    ...
    .end local v2    # "diff":J
    :cond_1
    invoke-static {p1}, Landroid/support/t4/media/session/MediaSessionCompatApi14;->getRccStateFromState(I)I
...
.method public static setTransportControlFlags(Ljava/lang/Object;J)V
    ...
    .line 89
    .end local p0    # "rccObj":Ljava/lang/Object;
    invoke-static {p1, p2}, Landroid/support/t4/media/session/MediaSessionCompatApi18;->getRccTransportControlFlagsFromActions(J)I
...
.method public static unregisterMediaButtonEventReceiver(Landroid/content/Context;Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 63
    .local v0, "am":Landroid/media/AudioManager;
    sget-boolean v1, Landroid/support/t4/media/session/MediaSessionCompatApi18;->sIsMbrPendingIntentSupported:Z
