.class public abstract Landroid/support/t4/content/WakefulBroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/t4/content/WakefulBroadcastReceiver;->mActiveWakeLocks:Landroid/util/SparseArray;

    .line 66
    const/4 v0, 0x1

    sput v0, Landroid/support/t4/content/WakefulBroadcastReceiver;->mNextId:I
...
.method public static completeWakefulIntent(Landroid/content/Intent;)Z
    ...
    .line 119
    :cond_0
    sget-object v4, Landroid/support/t4/content/WakefulBroadcastReceiver;->mActiveWakeLocks:Landroid/util/SparseArray;

    monitor-enter v4

    .line 120
    :try_start_0
    sget-object v2, Landroid/support/t4/content/WakefulBroadcastReceiver;->mActiveWakeLocks:Landroid/util/SparseArray;
...
.method public static startWakefulService(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    .prologue
    .line 83
    sget-object v5, Landroid/support/t4/content/WakefulBroadcastReceiver;->mActiveWakeLocks:Landroid/util/SparseArray;

    monitor-enter v5

    .line 84
    :try_start_0
    sget v1, Landroid/support/t4/content/WakefulBroadcastReceiver;->mNextId:I

    .line 85
    .local v1, "id":I
    sget v4, Landroid/support/t4/content/WakefulBroadcastReceiver;->mNextId:I

    add-int/lit8 v4, v4, 0x1

    sput v4, Landroid/support/t4/content/WakefulBroadcastReceiver;->mNextId:I
