.class public final Landroid/support/t4/view/MotionEventCompat;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/t4/view/MotionEventCompat$ICSMotionEventVersionImpl;,
        Landroid/support/t4/view/MotionEventCompat$HoneycombMr1MotionEventVersionImpl;,
        Landroid/support/t4/view/MotionEventCompat$BaseMotionEventVersionImpl;,
        Landroid/support/t4/view/MotionEventCompat$MotionEventVersionImpl;
    }
.end annotation
...
.field static final IMPL:Landroid/support/t4/view/MotionEventCompat$MotionEventVersionImpl;
...
.method static constructor <clinit>()V
    ...
    .line 92
    new-instance v0, Landroid/support/t4/view/MotionEventCompat$ICSMotionEventVersionImpl;

    invoke-direct {v0}, Landroid/support/t4/view/MotionEventCompat$ICSMotionEventVersionImpl;-><init>()V

    sput-object v0, Landroid/support/t4/view/MotionEventCompat;->IMPL:Landroid/support/t4/view/MotionEventCompat$MotionEventVersionImpl;
    ...
    .line 94
    new-instance v0, Landroid/support/t4/view/MotionEventCompat$HoneycombMr1MotionEventVersionImpl;

    invoke-direct {v0}, Landroid/support/t4/view/MotionEventCompat$HoneycombMr1MotionEventVersionImpl;-><init>()V
    ...
    .line 96
    :cond_1
    new-instance v0, Landroid/support/t4/view/MotionEventCompat$BaseMotionEventVersionImpl;

    invoke-direct {v0}, Landroid/support/t4/view/MotionEventCompat$BaseMotionEventVersionImpl;-><init>()V
...
.method public static getAxisValue(Landroid/view/MotionEvent;I)F
    ...
    .prologue
    .line 475
    sget-object v0, Landroid/support/t4/view/MotionEventCompat;->IMPL:Landroid/support/t4/view/MotionEventCompat$MotionEventVersionImpl;

    invoke-interface {v0, p0, p1}, Landroid/support/t4/view/MotionEventCompat$MotionEventVersionImpl;->getAxisValue(Landroid/view/MotionEvent;I)F
...
.method public static getAxisValue(Landroid/view/MotionEvent;II)F
    ...
    invoke-interface {v0, p0, p1, p2}, Landroid/support/t4/view/MotionEventCompat$MotionEventVersionImpl;->getAxisValue(Landroid/view/MotionEvent;II)F
...
.method public static getButtonState(Landroid/view/MotionEvent;)I
    ...
    invoke-interface {v0, p0}, Landroid/support/t4/view/MotionEventCompat$MotionEventVersionImpl;->getButtonState(Landroid/view/MotionEvent;)I
