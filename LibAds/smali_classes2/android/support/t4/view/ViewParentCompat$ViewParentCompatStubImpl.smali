.class Landroid/support/t4/view/ViewParentCompat$ViewParentCompatStubImpl;
.super Ljava/lang/Object;
.source "ViewParentCompat.java"

# interfaces
.implements Landroid/support/t4/view/ViewParentCompat$ViewParentCompatImpl;
...
.method public onNestedFling(Landroid/view/ViewParent;Landroid/view/View;FFZ)Z
    ...
    .prologue
    .line 113
    instance-of v0, p1, Landroid/support/t4/view/NestedScrollingParent;

    if-eqz v0, :cond_0

    .line 114
    check-cast p1, Landroid/support/t4/view/NestedScrollingParent;

    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4, p5}, Landroid/support/t4/view/NestedScrollingParent;->onNestedFling(Landroid/view/View;FFZ)Z
...
.method public onNestedPreFling(Landroid/view/ViewParent;Landroid/view/View;FF)Z
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Landroid/support/t4/view/NestedScrollingParent;->onNestedPreFling(Landroid/view/View;FF)Z
...
.method public onNestedPreScroll(Landroid/view/ViewParent;Landroid/view/View;II[I)V
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4, p5}, Landroid/support/t4/view/NestedScrollingParent;->onNestedPreScroll(Landroid/view/View;II[I)V
...
.method public onNestedScroll(Landroid/view/ViewParent;Landroid/view/View;IIII)V
    ...
    .line 97
    check-cast v0, Landroid/support/t4/view/NestedScrollingParent;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/t4/view/NestedScrollingParent;->onNestedScroll(Landroid/view/View;IIII)V
...
.method public onNestedScrollAccepted(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)V
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Landroid/support/t4/view/NestedScrollingParent;->onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
...
.method public onStartNestedScroll(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)Z
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Landroid/support/t4/view/NestedScrollingParent;->onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
...
.method public onStopNestedScroll(Landroid/view/ViewParent;Landroid/view/View;)V
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2}, Landroid/support/t4/view/NestedScrollingParent;->onStopNestedScroll(Landroid/view/View;)V
